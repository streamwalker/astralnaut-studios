...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Astralnaut Studios" },
      { name: "twitter:description", content: "Astralnaut Studios and Real World Comics are imprints of Streamwalkers Corporation" },
