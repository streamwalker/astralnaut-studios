...
export const Route = createFileRoute("/sweepstakes/rules")({
  head: () => ({
    meta: [
      { title: "Weekly Sweepstakes — Official Rules · Real World Comics" },
      {
        name: "description",
        content:
          "Official Rules for the Real World Comics Weekly Sweepstakes. Not currently open.",
      },
      { property: "og:title", content: "Weekly Sweepstakes — Official Rules" },
      { property: "og:description", content: "The Weekly Sweepstakes is not currently open. Official Rules will be posted here before any promotion begins." },
