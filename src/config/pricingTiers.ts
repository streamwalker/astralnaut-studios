...
export const pricingTiers: PricingTier[] = [
  {
    ...
    headline: "All released pages. Every series.",
    timingLabel: "All released subscriber content.",
    features: [
      "All currently released subscriber pages across every series",
      "Forum access",
      "Canon voting power",
      "Motion-comic reader",
    ],
  ...
  },
  {
    ...
    headline: "Support the creators. Collect numbered variants.",
    timingLabel: "Early access when scheduled",
    features: [
      "Everything in Reader",
      "24-hour early access on scheduled releases",
  ...
  },
  {
    ...
    timingLabel: "Collector benefits + scheduled early access",
    valueCaption: "Physical print + cameo + Discord — the collector tier.",
    features: [
      "Everything in Initiate",
      "48-hour early access on scheduled releases",
